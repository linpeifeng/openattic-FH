    ...
    if (_.isObjectLike(this.cluster) && this.cluster.results &&
      ...
      this.cephIscsiService
        ...
        .then((res) => {
          ...
          //  this.$timeout(() => {
          //   this.getIscsiList().$promise.then((res)=>{
          //     console.log(res) // NEW ALL DATA
          //     console.log(this.selection) // CURRENT SELECTED DATA
          //     res | image1, image2, image3
          //     this.selection.image.settings['info'] = image3.settings['info']
          //   });
          // }, 60000);
        })
        .catch((error) => {
