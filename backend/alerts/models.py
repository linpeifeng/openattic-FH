...
class Alert_Info(models.Model):
    ...
    level = models.CharField(max_length=20,default='critical', choices=LEVEL_CHOICE)
...
class Snmp_Info(models.Model):
    ...
    snmp_version = models.CharField(max_length=20,default=0, choices=SNMP_VERSION, null=False)
    ...
    community_str = models.CharField(max_length=20, default='null', null=True, blank=True)
    authmeth = models.CharField(max_length=20, default='noAuthNoPriv', null=True,
                                blank=True, choices=AUTH_CHO)
    authuser = models.CharField(max_length=30, default='null', null=True, blank=True)
    authpasswd = models.CharField(max_length=30, default='null', null=True, blank=True)
    ...
    privpasswd = models.CharField(max_length=30, default='', null=True, blank=True)
...
class Disk_Info(models.Model):
    wwn = models.CharField(primary_key=True, max_length=50,
                           default='null', null=False)
    hostname = models.CharField(max_length=50, default='null', null=False)
    osd = models.CharField(max_length=50, default='null', null=False)
    disk = models.CharField(max_length=50, default='null', null=False)
    solt = models.CharField(max_length=300, default='null', null=False)
    otherinfo = models.CharField(max_length=300, default='null', null=True, blank=True)
