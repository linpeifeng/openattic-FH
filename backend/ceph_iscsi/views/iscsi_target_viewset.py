...
class iSCSITargetViewSet(NodbViewSet):
    queryset = iSCSITarget.objects.all()
    ...
    def bulk_delete(self, request, *args, **kwargs):
        delper = 'ceph_iscsi.delete_iscsiinterface'
        allper = User.objects.get(username=request.user).get_all_permissions()
        if delper in allper:
            ...
            return Response(status=403, data={"detail":"You do not have permission to perform this action."})
